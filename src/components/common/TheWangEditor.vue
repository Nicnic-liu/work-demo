...
<script>
    //import uploadPath from '../../components/uploadPhoto/index'
    ...
    export default {
        ...
        methods: {
            seteditor() {
                ...
                this.editor.customConfig.uploadImgServer = `http://aliyun/uploadImg1`
